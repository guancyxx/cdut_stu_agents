#!/usr/bin/env python3
"""
QDUOJ FPS Import Script with Extended Version Support
Supports FPS version 1.1, 1.2, and 1.5
"""
import os
import sys
...
class ExtendedFPSParser(BaseFPSParser):
    ...
    def __init__(self, fps_path=None, string_data=None):
        ...
        print(f"Parsing FPS version {version}")
...
def import_fps_file(fps_file_path, creator_username='root'):
    ...
    try:
        ...
        print(f"Creator user: {creator.username}")
    except User.DoesNotExist:
        print(f"Error: User '{creator_username}' not found")
        return 0
    
    # Parse FPS file using extended parser
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python import_fps_v15.py <fps_file_path>")
        sys.exit(1)
    ...
    print("=" * 60)
    print("QDUOJ FPS Import Tool (Extended Version Support)")
    print("=" * 60)
    print()
